...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='priorities',
            field=models.ManyToManyField(related_name='post_priorities', to='posts.Priority'),
        ),
        migrations.AddField(
            model_name='post',
            name='tags',
        ...
        migrations.AddField(
            model_name='post',
            name='visit_users',
            field=models.ManyToManyField(related_name='visit_posts', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Facility',
            fields=[
